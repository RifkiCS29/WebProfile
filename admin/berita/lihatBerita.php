...
?>
	<div class="row">
      <div class="col-md-5">
        <img data-src="holder.js/300x200" alt="300x200" src="<?=$hasil_data['gambar'];?>" style="width: 350px; height: 250px;">
      </div>
      <div class="col-md-7">
          ...
          <p>
		  	<a href="index.php?link=formubahberita.php&id=<?=$hasil_data['id_berita'];?>"><button type="button" class="btn btn-success"> Ubah Berita </button></a>
			<a href="proses-hapus.php?id_berita=<?=$hasil_data['id_berita'];?>"><button type="button" class="btn btn-warning" onclick="return confirm( 'Apakah kamu yakin Menghapus Berita ?')"> Hapus Berita </button></a>
